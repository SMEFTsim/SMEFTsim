...
dWHb = Parameter(name = 'dWHb',
                 nature = 'internal',
                 type = 'real',
                 value = 'yb/(yb + 10**-40)*(-0.5809*dGf + 1.1618*dkH - (1.1618*vevhat**2*(cdH0 + DeltadcdH*yb**2 + DeltaucdH*yt**2))/LambdaSMEFT**2)',
                 texname='\\text{dWHb}')
