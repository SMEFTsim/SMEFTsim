...
dWW = Parameter(name = 'dWW',
                nature = 'internal',
                type = 'real',
                value = '(dMW*WW)/MWsm + (2*dgw + (2*(2*cHj3 + cHl3)*vevhat**2)/(3.*LambdaSMEFT**2))*WW',
                texname = '\\text{dWW}')
