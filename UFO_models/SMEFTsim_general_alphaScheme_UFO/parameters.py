...
dWW = Parameter(name = 'dWW',
                nature = 'internal',
                type = 'real',
                value = '(dMW*WW)/MWsm + (2*dgw + (2*(cHl3Re11 + cHl3Re22 + cHl3Re33 + 3*cHq3Re11 + 3*cHq3Re22)*vevhat**2)/(9.*LambdaSMEFT**2))*WW',
                texname = '\\text{dWW}')
